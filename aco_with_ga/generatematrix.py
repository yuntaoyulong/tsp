...
# 指定要遍历的文件夹路径  
folder_path = "E:\\MiniProject\\zhuhai"
coordinates_dict = {}
numtolocation = {}
file_counter = 1
# 遍历文件夹  
    ...
    for root, dirs, files in os.walk(folder_path):  
        for file in files:  
            ...
            if jpg_path.endswith('.jpg'):
                ...
                cv2.imwrite(f"E:\\MiniProject\\huishou\\{file_counter}.jpg", roi)
                cv2.imwrite(f"E:\\MiniProject\\huishou\\ab{file_counter}.jpg", roi1)
...
start_index = 115 
end_index = 116
distance_matrix[n, :] = 6e7
distance_matrix[:, n] = 6e7
distance_matrix[start_index, n] = 10
distance_matrix[n, start_index] = 10
distance_matrix[end_index, n] = 10
distance_matrix[n, end_index] = 10
